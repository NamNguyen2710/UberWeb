      ...
      <div className="footer">
        <div className="flex">
          ...
          <div className="iconBox">
            ...
            <a href="https://www.linkedin.com"><img className="icon" src={yt_ico} alt="Linked_icon"/></a>
            <a href="https://www.youtube.com"><img className="icon" src={linked_ico} alt="Youtube_icon"/></a>
          </div>
        </div>
      </div>
    );
